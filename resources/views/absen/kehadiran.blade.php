...
<body class="scrol-mati">
    ...
    <form class="bg-gradient" action="{{ route('absen.store') }}" method="POST">
        ...
        <div class="container absen text-gray-800">
            <div class="clock d-flex fw-bold text-center mr-3">
                <p id="clock"></p>
            </div>
            <div class="row">
                <div class="col">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control input-tema" name="id_karyawan" id="id_karyawan"
                            required>
                    </div>

                    <button type="submit" class="form-control btn btn-tema">absen</button>
